...
$routes->get('updateEmployeeSuspend', 'AdminController::updateEmployeeSuspend',['filter' => 'authCheck']);
...
$routes->get('activateCourse', 'AdminController::activateCourse',['filter' => 'authCheck']);
$routes->get('suspendCourse', 'AdminController::suspendCourse',['filter' => 'authCheck']);
