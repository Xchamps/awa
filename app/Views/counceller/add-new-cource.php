      ...
      <main>
        <div class="content-wrapper">
          ...
          <div class="content-header">
            <h2 class="text-capitalize">add cource</h2>
          </div>
          <!-- content -->
            ...
            <div class="row">
              <div class="col-md-4">
                ...
                <div class="card">
                  <div class="student-block">
                    ...
                    <div class="text-capitalize idNo">id no : 123</div>
                  </div>
                  <div class="card-content">
                    <ul class="studInfo m-0">
                      ...
                      <li>
                        ...
                        <div class="text-capitalize">info@gmail.com</div>
                      </li>

                      <li>
                        <div class="text-bold text-capitalize">
                          <i class="glyphicon glyphicon-map-marker"></i>Adress</div>
                        <div class="text-capitalize">basheerbagh</div>
                      </li>
                      <li>
                        <div class="text-bold text-capitalize">
                          <i class="glyphicon glyphicon-credit-card"></i>Aadhar card</div>
                        <div class="text-capitalize">1234567890</div>
                      </li>
                    </ul>
                  </div>
                </div>
                <div class="card">
                  <div class="student-block no-bg courseInf-block">
                    
                    <div class="profile-pic">
                      <img src="images/web-designing.png" alt="">
                    </div>
                    <!-- skills -->
                    <div class="text-uppercase skils-column">
                      <span class="badge">html</span>
                      <span class="badge">css</span>
                      <span class="badge">javscript</span>
                    </div>
                  </div>
                  <div class="card-content">
                    <ul class="studInfo couInfo m-0">
                      <li><b>start date :</b><span>12-03-2019</span>
                      </li>
                      <li><b>end date :</b><span>12-06-2019</span>
                      </li><li><b>comment :</b><span>lorem ipsum dolor spli emit</span>
                      </li>
                    </ul>
                  </div>
                </div>
              ...
              <div class="col-md-8">
                <div class="card row top-bar-info">
                    ...
                    <div class="card-content">
                      <div class="clsses_wrapper clsses_wrapper2">
                        <div class="row d-flex">
                          ...
                          <div class="col-md-6 form-group">
                            <label class="text-capitalize">cource type</label>
                            <select class="form-control text-capitalize">
                          ...
                          <div class="col-md-12 form-group">
                            <label class="text-capitalize">modules</label>
                            <input type="text" class="form-control" list="modulesList" name="modulesLists" placeholder="Enter module name">
                            <datalist id="modulesList">
                              <option value="module 1">
                              </option><option value="module 2">
                              </option><option value="module 3">
                              </option><option value="module 4">
                            </option></datalist>
                            <div class="added_modules skils-column" style="margin-top: 15px;">
                                    ...
                                    <tr>
                                      <th>
                                        <div class="customradio">
                                          ...
                                          <span class="text-uppercase">All modules</span>
                                        </div>
                                      </th>
                                    </tr>
                                  </thead>
                                  <tbody>
                                    <tr>
                                      <td>
                                        <div class="customradio">
                                          <input type="checkbox" name="selectComapny">
                                          <span class="text-uppercase">module 1</span>
                                        </div>
                                      </td>
                                      <td class="text-right">
                                    ...
                                    <tr>
                                      <td>
                                        <div class="customradio">
                                          <input type="checkbox" name="selectComapny">
                                          <span class="text-uppercase">module 2</span>
                                        </div>
                                      </td>
                                      <td class="text-right">
                                        <button class="btn btn-sm btn-danger">Remove</button>
                                    ...
                                    <tr>
                                      <td>
                                        <div class="customradio">
                                          <input type="checkbox" name="selectComapny">
                                          <span class="text-uppercase">module 3</span>
                                        </div>
                                      </td>
                                      <td class="text-right">
                                        <button class="btn btn-sm btn-danger">Remove</button>
