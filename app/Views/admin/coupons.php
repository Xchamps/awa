...
<html>
  ...
  <body>
      ...
      <main>
        <div class="content-wrapper">
          ...
          <div class="content-header">
            <h2 class="text-capitalize">Coupons</h2>
            <div class="header-elements scStdntsListTabs">
              <ul class="nav nav-pills nav-stacked">
                <li>
                  <div class="form-group selctbox-filter m-0">
                    <input type="text" list="persons" class="form-control" placeholder="sort by persons">
                    <datalist id="persons">
                      <option class="text-capitalize" value="Pradeep">
                      <option class="text-capitalize" value="Abhinay">
                      <option class="text-capitalize" value="vimal">
                      <option class="text-capitalize" value="Mahesh">
                    </datalist>
                  </div>
                </li>
                <li class="text-right">
                  <button class="btn btn-primary text-capitalize" data-toggle="modal" data-target="#add-coupons">Add coupon</button>
                </li>
              </ul>
            </div>
          </div>
          <div class="content-body">
            <div class="card">
              <div class="card-header">
                <h3 class="text-capitalize">coupons list</h3>
              </div>
                ...
                <table class="table table-striped custom-table">
                  <thead>
                    <tr>
                      ...
                      <th class="text-capitalize">coupon code</th>
                      <th class="text-capitalize">generated date</th>
                      <th class="text-capitalize">Discount</th>
                      <th class="text-capitalize">Person used</th>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>
                        <span class="badge badge-success">infasta</span>
                        <span class="badge badge-secondary">awa</span>
                      </td>
                      <td>
                        <button class="btn btn-default text-capitalize" data-toggle="modal" data-target="#add-coupons">Edit</button>
                        <button class="btn btn-sm btn-success text-capitalize">active</button>
                        <button class="btn btn-sm btn-danger text-capitalize">Suspend</button>
                      </td>
                    </tr>
                    <tr>
                      <td>2</td>
                      ...
                      <td>Pradeep</td>
                      <td>
                        <span class="badge badge-primary">infasta</span>
                      </td>
                      <td>
                        <button class="btn btn-default text-capitalize" data-toggle="modal" data-target="#add-coupons">Edit</button>
                        <button class="btn btn-sm btn-success text-capitalize">active</button>
    ...
    <div id="add-coupons" class="modal fade" role="dialog">
          ...
          <div class="modal-body">
            <form>
              <div class="row">
                <div class="col-sm-6">
                  <div class="form-group">
                    <label for="">Generated key</label><br>
                    <strong class="text-primary" style="font-size: 18px;">web-01</strong>
                  </div>
                </div>
                <div class="col-sm-6">
                  <label for="">Select discoount type</label>
                  <div class="form-group">
                    <div class="customradio">
                      <input type="radio" name="discount" value="amount">
                      <span class="text-capitalize">amount</span>
                    </div>
                    <div class="customradio">
                      <input type="radio" name="discount" value="percentage">
                      <span class="text-capitalize">percentage</span>
                    </div>
                  </div>
                </div>
                <div class="col-sm-12">
                  <div class="form-group">
                    <input type="text" class="form-control" checked id="amount" placeholder="Enter Amount">
