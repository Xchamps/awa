...
<html>
  ...
  <body>
        ...
        <nav class="navbar bg-7" id="sticky-nav">
          <div class="collapse navbar-collapse" id="myNavbar">
            <ul class="nav navbar-nav">
              ...
              <li class="active">
                <a href="super-admin/managers.html">managers</a>
              </li>
              <li>
                <a href="super-admin/employees.html">employees</a>
              </li>
              <li>
      ...
      <main>
        <div class="content-wrapper">
          ...
          <div class="content-header">
            <h2 class="text-capitalize">managers</h2>
            <div class="header-elements scStdntsListTabs">
              <ul class="nav nav-pills nav-stacked">
                <li class="">
                <button class="btn btn-white text-capitalize" data-toggle="modal" data-target="#add-manager">Add manager</button>
                </li>
              </ul>
            </div>
          </div>
          <div class="content-body">
              <div class="card">
                <div class="card-header">
                  <h3 class="text-capitalize">Manager list</h3>
                </div>
                <div class="card-content">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>
                          <button class="btn btn-default text-capitalize" data-toggle="modal" data-target="#add-manager">Edit</button>
                      ...
                      <tr>
                        ...
                        <td>
                          <div>
                            ...
                            <span class="badge badge-warning">branch name</span>
                          </div>
                        </td>
                        <td>
                          <button class="btn btn-default text-capitalize" data-toggle="modal" data-target="#add-manager">Edit</button>
    ...
    <!-- modals -->
    <div id="add-manager" class="modal fade" role="dialog">
