      ...
      <nav class="navbar bg-7" id="sticky-nav">
        <div class="collapse navbar-collapse" id="myNavbar">
          <ul class="nav navbar-nav">
            <li class="one">
              <a href="<?= base_url() ?>admin/branch">branches</a>
            </li>
            <li class="one">
              <a href="<?= base_url() ?>admin/employees">users</a>
            </li>
            <li class="one">
            ...
            <li class="one">
              <a href="<?= base_url() ?>admin/banks">Bank accounts</a>
            </li>
            <li class="one">
              <a href="<?= base_url() ?>admin/online-payments">online payments</a>
            </li>
            <li class="one">
              <a href="<?= base_url() ?>admin/hoildays">hoildays</a>
            </li>
          </ul>
        </div>
      </nav>
