...
if (!empty($_POST['submit']) && $_POST['submit'] == 'Save') {
    ...
    if (!wp_verify_nonce($nonce, 'sbimagegeneraleffects')) {
        ...
        $css = 'sb-image-radius |50| sb-image-item |sb-image-hover-responsive-1| sb-image-image-type |normal| sb-image-image-autoplay |yes| sb-image-auto-timing |2000| sb-image-width |250| sb-image-height |250| sb-image-margin |20| sb-image-padding |20| sb-image-animation || sb-image-animation-duration |2| sb-image-link-opening |_blank| sb-image-box-shadow |5| box-shadow-color |rgba(0, 148, 126, 0.36)| sb-image-inner-shadow |10| inner-shadow-color |rgba(49, 66, 222, 0.2)| sb-image-heading-font-size|20| sb-image-heading-font-family |Open+Sans| sb-image-heading-font-weight |600| sb-image-heading-font-style |normal| sb-image-heading-underline |no| sb-image-heading-padding-bottom |5| sb-image-heading-margin-bottom |10| sb-image-description-font-size |16| sb-image-description-font-family |Open+Sans| sb-image-description-font-weight |300| sb-image-description-font-style |normal| sb-image-description-margin-bottom |20| sb-image-button-font-size |14| sb-image-button-font-family |Open+Sans| sb-image-button-font-weight |300| sb-image-button-font-style |normal| sb-image-button-padding-left |10| sb-image-button-padding-top |10| sb-image-button-radius |5| sb-image-css || |';
